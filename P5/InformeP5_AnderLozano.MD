...
El programa escanea todas las direcciones posibles del bus I2C para detectar dispositivos conectados y permite identificar qué dispositivos I2C están presentes en el sistema.
...
```
Este código escanea el bus I2C en busca de dispositivos conectados y muestra sus direcciones en un display OLED. Se actualiza cada 5 segundos
...
```
Este código usa un sensor para medir la frecuencia cardíaca y la saturación de oxígeno en sangre. 
